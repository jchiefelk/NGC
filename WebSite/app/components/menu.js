  ...
  render: function () {
    ...
    return (
      <div>
        ...
        <Navbar fixedTop toggleNavKey={0} style={{backgroundColor: 'white',borderColor:'grey'}}  brand={<a> <img src='https://s3.amazonaws.com/nativegenchange/icons/blacklogo.png' style={{width: '45px',height:'45px',margin:'-13'}}/> </a>}>
          ...
          <Nav left eventKey={0}>  
              ...
              <NavItem eventKey={3} onClick={()=> this.setState({ showDonate: true })}> donate </NavItem>
              <NavItem eventKey={4} onClick={()=> this.setState({ showCalendar: true })}> news </NavItem>
          </Nav>
        </Navbar>
      ...
      <CalendarModal show={this.state.showCalendar} onHide={Close} />
