  ...
  render: function () {
    ...
    return (
      <div>
        ...
        <Navbar fixedTop toggleNavKey={0} style={{backgroundColor: 'white',borderColor:'black'}} brand={<a> <img src={'https://s3.amazonaws.com/nativegenchange/icons/ngclogo.png'} style={{width: '45px',height:'45px',margin:'-13'}}/> </a>}>
